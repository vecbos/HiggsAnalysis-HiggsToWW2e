...
# run a dedicated ECAL clustering sequence
...
process.recoSequence = cms.Sequence ( process.islandClusteringSequence * process.muonCorrectedMET * process.jetSequence * process.pfjetSCSequence )

process.p = cms.Path ( process.recoSequence *
                       process.eIdSequence *
